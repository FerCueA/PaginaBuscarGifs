...
import { creaFooter } from "./components/footer";
import { crearFormularioBuscador } from "./components/formularioBuscador";
...
// CREANDO EL FOOTER
const footerContainer = document.querySelector(".footerNav");
const footer = creaFooter();
...
function crearEndpoint(apiKey, termino) {
  return `https://api.giphy.com/v1/gifs/search?api_key=${apiKey}&q=${encodeURIComponent(
    termino
  )}&limit=12`;
}
